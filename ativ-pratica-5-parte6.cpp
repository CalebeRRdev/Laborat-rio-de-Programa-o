...
double maiorTemperatura = *temperaturas;
int mesMaiorTemperatura = 1;
double menorTemperatura = *temperaturas;
int mesMenorTemperatura = 1;

// Percorre o vetor de temperaturas para encontrar a maior e a menor temperatura
for (int i = 1; i < 12; i++) {
  if (*(temperaturas + i) > maiorTemperatura) {
    maiorTemperatura = *(temperaturas + i); // corrigido para usar dereference
    mesMaiorTemperatura = i+1;
  }
  if (*(temperaturas + i) < menorTemperatura) { // corrigido para usar dereference
